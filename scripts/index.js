...
const filterBtns = [allBtn, cseBtn, wddBtn]
...
function renderCourses(filteredCourses) {
    ...
    filteredCourses.forEach(course => {
        ...
        `
        coursesDiv.appendChild(courseEl)
    })
}
// ${course.title}</h3>
...
function updateTotalCredits(coursesList) {
    const total = coursesList.reduce((sum, course) => sum + course.credits, 0)
    document.getElementById('totalCredits').textContent = `The total credit for these courses is ${total}`
}
